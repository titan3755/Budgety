...
export default function Privacy() {
    return (
        <Fragment>
            <div className="p-5">
            <h1 className="my-3 font-bold font-ubuntu">Privacy Policy for PhotoBytes Studios</h1>
            <p>
                At Budgety, accessible from https://budgety.ml, one of our main priorities
                is the privacy of our visitors. This Privacy Policy document contains types
                of information that is collected and recorded by Budgety and how we use it.
            </p>
            <p>
            ...
            <p>
                ...
                and/or collect in Budgety. This policy is not applicable to any information
                collected offline or via channels other than this website.
            </p>
            <h2 className="font-extrabold font-overpass text-3xl my-6">Consent</h2>
            <p>
                By using our website, you hereby consent to our Privacy Policy and agree to
                its terms.
            </p>
            <h2 className="font-extrabold font-overpass text-3xl my-6">Information we collect</h2>
            <p>
            ...
            <h2 className="font-extrabold font-overpass text-3xl my-6">How we use your information</h2>
            ...
            <h2 className="font-extrabold font-overpass text-3xl my-6">Log Files</h2>
            <p>
                Budgety follows a standard procedure of using log files. These files log
            ...
            <h2 className="font-extrabold font-overpass text-3xl my-6">Cookies and Web Beacons</h2>
            <p>
                Like any other website, Budgety uses 'cookies'. These cookies are used to
            ...
            <h2 className="font-extrabold font-overpass text-3xl my-6">Advertising Partners Privacy Policies</h2>
            <p>
                You may consult this list to find the Privacy Policy for each of the
                advertising partners of Budgety.
            </p>
            <p>
                Third-party ad servers or ad networks uses technologies like cookies,
                JavaScript, or Web Beacons that are used in their respective advertisements
                and links that appear on Budgety, which are sent directly to users' browser.
            ...
            <p>
                Note that Budgety has no access to or control over these cookies that are
                used by third-party advertisers.
            </p>
            <h2 className="font-extrabold font-overpass text-3xl my-6">Third Party Privacy Policies</h2>
            <p>
                Budgety's Privacy Policy does not apply to other advertisers or websites.
            ...
            <h2 className="font-extrabold font-overpass text-3xl my-6">CCPA Privacy Rights (Do Not Sell My Personal Information)</h2>
            <p>
            ...
            <h2 className="font-extrabold font-overpass text-3xl my-6">GDPR Data Protection Rights</h2>
            <p>
            ...
            <h2 className="font-extrabold font-overpass text-3xl my-6">Children's Information</h2>
            <p>
            ...
            <p>
                Budgety does not knowingly collect any Personal Identifiable Information
